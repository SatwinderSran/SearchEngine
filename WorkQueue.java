...
public class WorkQueue {
	...
	/**
	 * Increases pending variable as new tasks are given to queue
	 */
	...
	/**
	 * Waits for all pending work to be finished and notifies all threads when pending is equal to zero.
	 */
	...
	public synchronized void finish() {
		...
		{
			System.err.println("error while finishing");
		}
	}
